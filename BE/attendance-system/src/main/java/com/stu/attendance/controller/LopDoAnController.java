...
public class LopDoAnController {
    ...
    @PutMapping("/{maLopDoAn}")
    public ResponseEntity<LopDoAnDTO> updateLopDoAn(@PathVariable Integer maLopDoAn, @Valid @RequestBody LopDoAnDTO lopDoAnDTO) {
        try {
            LopDoAnDTO updated = lopDoAnService.updateLopDoAn(maLopDoAn, lopDoAnDTO);
