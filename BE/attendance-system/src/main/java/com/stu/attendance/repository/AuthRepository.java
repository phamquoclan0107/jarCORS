...
public interface AuthRepository extends JpaRepository<TaiKhoan, String> {
    ...
    Optional<TaiKhoan> findByZaloId(String zaloId);
    ...
    @Modifying
    @Transactional
    @Query("UPDATE TaiKhoan tk SET tk.matKhau = :newPassword WHERE tk.nguoiDung.maNguoiDung = :maNguoiDung")
    void updatePasswordByMaNguoiDung(@Param("maNguoiDung") String maNguoiDung, @Param("newPassword") String newPassword);
