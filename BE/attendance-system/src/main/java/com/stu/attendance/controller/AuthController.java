...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> loginWithZalo(@Valid @RequestBody ZaloLoginRequest zaloLoginRequest) {
        return ResponseEntity.ok(authService.authenticateWithZalo(zaloLoginRequest));
    }
