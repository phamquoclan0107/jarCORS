...
public class LopDoAnService {
    ...
    @Transactional
    public LopDoAnDTO updateLopDoAn(Integer maLopDoAn, LopDoAnDTO lopDoAnDTO) {
        ...
        // Chỉ cập nhật những trường bạn muốn thay đổi
        if (lopDoAnDTO.getTenLopDoAn() != null) {
            lopDoAn.setTenLopDoAn(lopDoAnDTO.getTenLopDoAn());
        }
        if (lopDoAnDTO.getGhiChu() != null) {
            lopDoAn.setGhiChu(lopDoAnDTO.getGhiChu());
        }
        if (lopDoAnDTO.getThoiGianBatDau() != null) {
            lopDoAn.setThoiGianBatDau(lopDoAnDTO.getThoiGianBatDau());
        }
        if (lopDoAnDTO.getThoiGianKetThuc() != null) {
            lopDoAn.setThoiGianKetThuc(lopDoAnDTO.getThoiGianKetThuc());
        ...
        LopDoAn saved = lopDoAnRepository.save(lopDoAn);
